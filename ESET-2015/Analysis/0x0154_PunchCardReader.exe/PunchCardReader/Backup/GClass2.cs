        ...
        while (true)
        {
          ...
          switch (num1 ^ num2)
          {
            ...
            case 5:
              ...
              byte_2_1 = new byte[(IntPtr) BitConverter.ToUInt32(byte_2_4, 0)];
              num1 = 371085156;
              continue;
            case 6:
              goto label_14;
...
label_5:
    ...
    private void method_5(byte[] byte_2)
    {
      ...
      // ISSUE: reference to a compiler-generated method
      this.namedPipeClientStream_0.BeginRead(class1.method_0(), 0, class1.method_0().Length, new AsyncCallback(this.method_6), (object) class1);
    ...
    private void method_6(IAsyncResult iasyncResult_0)
    {
      ...
      // ISSUE: reference to a compiler-generated method
      int int_1 = class1.method_4().EndRead(iasyncResult_0);
label_10:
      int num1 = -2058269143;
      while (true)
      {
        ...
        switch (num1 ^ num2)
        {
          ...
          case 1:
            ...
            int num4;
            // ISSUE: reference to a compiler-generated method
            if (class1.method_6(int_1) != class1.method_0().Length)
            {
              int num5 = -2058269139;
              num4 = -2058269139;
              num3 = num5;
          ...
          case 5:
            // ISSUE: reference to a compiler-generated method
            if (class1.method_4().IsConnected)
            {
              // ISSUE: reference to a compiler-generated method
              // ISSUE: reference to a compiler-generated method
              // ISSUE: reference to a compiler-generated method
              // ISSUE: reference to a compiler-generated method
              // ISSUE: reference to a compiler-generated method
              class1.method_4().BeginRead(class1.method_0(), class1.method_2(), class1.method_0().Length - class1.method_2(), new AsyncCallback(this.method_6), (object) class1);
              num1 = -2058269140;
              continue;
            }
            goto label_11;
